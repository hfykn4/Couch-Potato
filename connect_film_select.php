...
<style>
 body {
    ...
    h1 {
        font-weight: 600;
        text-align: center;background: linear-gradient(to bottom left, #33cccc -1%, #ffff66 100%);
        color: #fff;
        padding: 10px 0px;
    }
...
<div class="modal fade" id="modal_success" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
            <div class="modal-header" style="background: linear-gradient(to bottom left, #33cccc -1%, #ffff66 100%)">
