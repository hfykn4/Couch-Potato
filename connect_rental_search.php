...
if (!$search1) {
	if (!$search2) {
		$sql = "SELECT * FROM rental WHERE customer_id = '$search3'";
	}
	else if (!$search3) {
		$sql = "SELECT * FROM rental WHERE inventory_id = '$search2'";
	}
	else 
	{
		$sql = "SELECT * FROM rental WHERE inventory_id = '$search2' AND customer_id = '$search3'";
	}
} 
	...
	if (!$search1) {
		...
		$sql = "SELECT * FROM rental WHERE rental_id = '$search1'";
	}
	else 
	{
		$sql = "SELECT * FROM rental WHERE rental_id = '$search1' AND customer_id = '$search3'";
	}
}
	...
	{
		$sql = "SELECT * FROM rental WHERE rental_id = '$search1' AND inventory_id = '$search2'";
	}
} 
 else 
{	
	$sql = "SELECT * FROM rental WHERE rental_id = '$search1' AND inventory_id  = '$search2' AND customer_id  = '$search3' ";
}
