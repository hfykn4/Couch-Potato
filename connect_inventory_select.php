...
<div class="modal fade" id="modal_success" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
            <div class="modal-header" style=" background: linear-gradient(to bottom right, #ffff99 23%, #ff9933 100%)">
...
if ($result->num_rows > 0) {
    echo "<table><tr><th>Inventory ID</th><th>Film ID</th><th>Store</th><th>Last Update</th></tr>";
