...
if (!$search1) {
	$sql = "SELECT * FROM actor WHERE first_name = '$search2'";
} 
else if (!$search2) 
{
	$sql = "SELECT * FROM actor WHERE actor_id = '$search1'";
} else
{
	$sql = "SELECT * FROM actor WHERE actor_id = '$search1' AND first_name = '$search2'";
}
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo "<table><tr><th>Actor ID</th><th>First Name</th><th>Last Name</th><th>Last Update</th></tr>";
